...
export default function Bolsas2025Page() {
  ...
  const diferenciais = [
    {
      ...
      description: "Descontos de 20% a 100% na mensalidade, baseados no desempenho e análise socioeconômica.",
      color: "bg-blue-500"
    },
    {
      icon: GraduationCap,
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "A avaliação aborda conteúdos do ano letivo atual. Recomendamos revisar português, matemática e conhecimentos gerais."
    },
    {
      question: "Qual é o valor da bolsa?",
      answer: "As bolsas variam de 20% a 100% de desconto na mensalidade, dependendo do desempenho e análise socioeconômica."
    },
    {
    ...
    },
    {
      ...
      answer: "Cada candidato pode participar apenas uma vez por processo seletivo anual."
    }
  ];
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                Você receberá um e-mail de confirmação em breve com mais detalhes sobre o processo.
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8 text-center">
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div>
                ...
                <p className="text-orange-100">info@colegioose.com.br</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <div>
                ...
                <p className="text-orange-100">Rua da Penha, 620 - Sorocaba/SP</p>
              </div>
            </div>
          </div>
