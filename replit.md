...
- June 26, 2025: Content updates: Fixed Ensino Fundamental I program features to show "{CODE.OSE} Linguagem Programação" instead of "CODE OSE Programação"; Updated differentials section replacing CODE.OSE with "Facilidade de Acesso" describing Pau Brasil parking convenience for families
```
